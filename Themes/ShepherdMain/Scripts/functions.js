...
(function($){
        ...
        maxHeight: function(){
            if( $commonHeightEl.length > 0 ) {
                $commonHeightEl.each( function(){
                    ...
                    parentEl.children('[class^=col-] .team').each(function() {
                        $(this).height(maxHeight);
                    });
                });
            }
        ...
        pageTransition: function(){
            if( !$body.hasClass('no-transition') ){
                $wrapper.animsition({
                    ...
                    inDuration : 1500,
                    outDuration : 800,
                    linkElement: '#primary-menu ul.primary-menu li a:not([target="_blank"]):not([href^=#])',
                    loading : true,
    ...
    SEMICOLON.header = {
        ...
        superfish: function(){
            ...
            if ( $().superfish ) {
                if( $body.hasClass('device-lg') || $body.hasClass('device-md') ) {
                    $('#primary-menu ul.primary-menu ul, #primary-menu ul.primary-menu .mega-menu-content').css('display', 'block');
                    SEMICOLON.header.menuInvert();
                }

                $('body:not(.side-header) #primary-menu ul.primary-menu, body:not(.side-header) #primary-menu > div > ul,.top-links > ul').superfish({
                ...
                $('body.side-header #primary-menu ul.primary-menu').superfish({
                    popUpSelector: 'ul',
                    delay: 250,
                    speed: 350,
        ...
        menuInvert: function() {
            ...
            $('#primary-menu .mega-menu-content, #primary-menu ul.primary-menu ul').each(function (index, element) {
        ...
        menufunctions: function(){
            ...
            $('#primary-menu ul.primary-menu li:has(ul)').addClass('sub-menu');
            $( '.top-links ul li:has(ul) > a' ).append( ' <i class="icon-angle-down"></i>' );
            $( '.top-links > ul' ).addClass( 'clearfix' );

            if( $body.hasClass('device-lg') || $body.hasClass('device-md') ) {
                $('#primary-menu.sub-title ul.primary-menu > li,#primary-menu.sub-title > div > ul > li').hover(function () {
        ...
        topsearch: function(){
			...
			$("#primary-menu-trigger-close").click(function(e){
    ...
    SEMICOLON.widget = {
        ...
        extras: function(){
            ...
            $('#primary-menu-trigger').click(function() {
                $('#primary-menu ul.primary-menu').toggleClass("show");
    ...
    var $window = $(window),
        ...
        $topSocialEl = $('#top-social').find('> ul > li:not(.login-zone)'),
        $siStickyEl = $('.si-sticky'),
        $dotsMenuEl = $('.dots-menu'),
        $goToTopEl = $('#gotoTop'),
        $fullScreenEl = $('.full-screen'),
        $commonHeightEl = $('.common-height'),
        $commonHeightImgEl = $('.common-height-img'),
